...
N_CLASSES = 20
DATA_DIR = '/media/il/local2/Virtual_try_on/Preprocessing/pre_exp'
NUM_STEPS = len(os.listdir(DATA_DIR)) 
print(f"total test images: {NUM_STEPS}")
RESTORE_FROM = '/media/il/local2/Virtual_try_on/Preprocessing/modules/CIHP_PGN/checkpoint/CIHP_pgn'
...
def main():
    ...
    # evaluate prosessing
    parsing_dir = './stableVTON/cihp_parsing_maps'
