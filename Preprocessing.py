...
def main(input_paths, output_paths, mask_paths,label_paths,img_paths):
    ...
    for i in range(num_steps):
        ...
        #resize_and_copy_images(input_folder,img_folder)
        #subprocess.run([
        #    "python3", "/media/il/local2/Virtual_try_on/Preprocessing/Self-Correction-Human-Parsing-for-ACGPN/simple_extractor.py",
        #    '--dataset', 'atr',
        #    '--model-restore', '/media/il/local2/Virtual_try_on/Preprocessing/Self-Correction-Human-Parsing-for-ACGPN/atr.pth',
        #    '--input-dir', img_folder,
        #    '--output-dir', label_folder
        ...
        #process_images(img_folder, output_folder, label_folder, mask_folder)
        resize_and_overwrite_images(label_folder)
        #process_folder_for_largest_contour(output_folder,output_folder)
